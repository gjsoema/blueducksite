...
function submitRefcode() {
    ...
    fetch(`https://77.221.154.46:80/api4?uid=${enter_refcode.value}`)
        .then((response) => {
...
function popUpTg() {
    ...
    document.querySelector('.get__btn').addEventListener('click', () => {
        ...
        setTimeout(function () {
            ...
            pre.innerHTML = "&#10004";
            fetch(`https://77.221.154.46:80/api5?uid=${uid}&taskid=${2}`)
                .then((response) => {
                    return response.json();
                }).then((result) => {
                    fetch(`https://77.221.154.46:80/api?uid=${uid}`)
                        .then((response) => {
                            return response.json();
                        }).then((result) => {
                            bd = result;
...
function popUpRt() {
    ...
    document.querySelector('.get__btn').addEventListener('click', () => {
        ...
        setTimeout(function () {
            pre.classList.remove("loader")
            pre.innerHTML = "&#10004";
            fetch(`https://77.221.154.46:80/api5?uid=${uid}&taskid=${3}`)
                .then((response) => {
                    return response.json();
                }).then((result) => {
                    fetch(`https://77.221.154.46:80/api?uid=${uid}`)
...
function popUpTwitter() {
    ...
    document.querySelector('.get__btn').addEventListener('click', () => {
        ...
        setTimeout(function () {
            pre.classList.remove("loader")
            pre.innerHTML = "&#10004";
            fetch(`https://77.221.154.46:80/api5?uid=${uid}&taskid=${1}`)
                .then((response) => {
                    return response.json();
                }).then((result) => {
                    fetch(`https://77.221.154.46:80/api?uid=${uid}`)
    ...
    //    window.location.replace("https://77.221.154.46:80/redirect");
    //}
